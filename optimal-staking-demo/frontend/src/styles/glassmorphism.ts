export const glassStyles = {
  ...
  backgroundGradient: {
    ...
    top: 0,
    left: 0,
    background: 'linear-gradient(135deg, #1D2939 0%, #161618 50%, #1D2939 100%)',
    zIndex: -1,
    '&::before': {
      content: '""',
      position: 'absolute',
      width: '100%',
      height: '100%',
      background: 'radial-gradient(circle at 20% 50%, rgba(109, 174, 255, 0.15) 0%, transparent 50%)',
    },
    '&::after': {
      content: '""',
      position: 'absolute',
      width: '100%',
      height: '100%',
      background: 'radial-gradient(circle at 80% 50%, rgba(109, 174, 255, 0.08) 0%, transparent 50%)',
    },
  },
};
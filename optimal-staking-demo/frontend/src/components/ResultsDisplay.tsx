...
export const ResultsDisplay: React.FC<ResultsDisplayProps> = ({ results, loading, autoCalculate, onDocumentClick }) => {
  ...
  const prepare3DSurfaceData = () => {
    if (!results.sensitivity_analysis_2d) {
      return { ethLevels: [], solLevels: [], teValues: [], netBenefitValues: [] };
    }

    // Get unique ETH and SOL levels
    const ethLevels = [...new Set(results.sensitivity_analysis_2d.map(p => p.eth_staking_level))].sort();
    const solLevels = [...new Set(results.sensitivity_analysis_2d.map(p => p.sol_staking_level))].sort();
    ...
    for (const ethLevel of ethLevels) {
      ...
      for (const solLevel of solLevels) {
        const point = results.sensitivity_analysis_2d.find(
          p => p.eth_staking_level === ethLevel && p.sol_staking_level === solLevel
        );
        if (point) {
  ...
  const { ethLevels, solLevels, teValues, netBenefitValues } = prepare3DSurfaceData();
  ...
  return (
    <Stack spacing={3}>
      ...
      <GlassCard>
        <Box p={2}>
          <Typography variant="h5" sx={{ mb: 1.5, ...glassStyles.gradientText }}>
            Main Results
          </Typography>
          ...
          <Grid container spacing={1.5}>
            ...
            <Grid item xs={12} lg={6}>
              <Box sx={{ ...glassStyles.statCard, p: 2, height: '100%' }}>
                <Typography variant="h6" sx={{ mb: 1.5, fontWeight: 600, color: '#6DAEFF' }}>
                  Performance Metrics
                </Typography>
                <Grid container spacing={2}>
                    ...
                    <Box>
                      ...
                      <Box sx={{ display: 'flex', alignItems: 'baseline', gap: 1 }}>
                        <Typography variant="h5" fontWeight={600} color="error">
                          {(results.net_benefit.expected_shortfall * 100).toFixed(3)}%
                        </Typography>
                        <InfoTooltip
                  ...
                  <Grid item xs={12} sm={4}>
                    <Box>
                      ...
                      <Box sx={{ display: 'flex', alignItems: 'baseline', gap: 1 }}>
                        <Typography variant="h5" fontWeight={600} sx={{ color: results.net_benefit.td_budget_deficit < 0 ? '#EF4444' : '#10B981' }}>
                          {(results.net_benefit.td_budget_deficit * 10000).toFixed(1)} bps
                        </Typography>
                        <InfoTooltip
                    ...
                    <Box>
                      ...
                      <Box sx={{ display: 'flex', alignItems: 'baseline', gap: 1 }}>
                        <Typography variant="h5" fontWeight={600} sx={{ color: '#10B981' }}>
                          {(results.net_benefit.total_yield_benefit * 100).toFixed(3)}%
                        </Typography>
                        <InfoTooltip
                    ...
                    <Box>
                      ...
                      <Box sx={{ display: 'flex', alignItems: 'baseline', gap: 1 }}>
                        <Typography variant="h5" fontWeight={600} sx={{ color: '#3B82F6' }}>
                          {(results.net_benefit.tracking_difference_budget * 10000).toFixed(1)} bps
                        </Typography>
                        <InfoTooltip
                  ...
                  <Grid item xs={12} sm={4}>
                    <Box>
                      ...
                      <Box sx={{ display: 'flex', alignItems: 'baseline', gap: 1 }}>
                        <Typography variant="h5" fontWeight={600} sx={glassStyles.gradientText}>
            ...
            <Grid item xs={12} lg={6}>
              <Box sx={{ ...glassStyles.statCard, p: 2, height: '100%' }}>
                <Typography variant="h6" sx={{ mb: 1.5, fontWeight: 600, color: '#10B981' }}>
                      ...
                      <Box sx={{ 
                        ...
                        <Box>
                          <Typography variant="h5" fontWeight={700} color="white">
                            {Math.round(results.optimal_staking_levels.eth * 100)}%
                          </Typography>
                          <Typography variant="caption" color="white" fontWeight={500} sx={{ fontSize: '0.7rem' }}>
                            ETH
                          </Typography>
                        </Box>
                      </Box>
                  ...
                  <Grid item xs={6}>
                    <Box sx={{ textAlign: 'center' }}>
                      <Box sx={{ 
                        ...
                        mb: 1,
                        borderRadius: '50%',
                        background: 'linear-gradient(135deg, #8DC4FF 0%, #6DAEFF 100%)',
                        display: 'flex',
                        alignItems: 'center',
                        justifyContent: 'center',
                        ...
                        <Box>
                          <Typography variant="h5" fontWeight={700} color="white">
                            {Math.round(results.optimal_staking_levels.sol * 100)}%
                          </Typography>
                          <Typography variant="caption" color="white" fontWeight={500} sx={{ fontSize: '0.7rem' }}>
                            SOL
                          </Typography>
      ...
      <GlassCard>
        <Box p={2}>
          ...
          {results.sensitivity_analysis_2d && ethLevels.length > 0 && solLevels.length > 0 ? (
            <Grid container spacing={1}>
              <Grid item xs={12} xl={6}>
                <Typography variant="subtitle1" sx={{ mb: 1, textAlign: 'center', fontWeight: 600, color: '#6DAEFF' }}>
                ...
                <Box sx={{ 
                  ...
                  <Plot
                    ...
                    layout={{
                      ...
                      scene: {
                        xaxis: {
                          ...
                          ticktext: ['70%', '75%', '80%', '85%', '90%', '95%', '100%']
                        },
                        yaxis: {
                        ...
                        zaxis: {
                          title: { text: 'Tracking Error (%)', font: { size: 14 } },
                          tickfont: { color: '#fff', size: 12 },
                          gridcolor: 'rgba(109,174,255,0.1)',
                          zerolinecolor: 'rgba(109,174,255,0.2)',
                          showspikes: false
                    ...
                    config={{ 
                      ...
                      displaylogo: false,
                      modeBarButtonsToRemove: ['toImage', 'sendDataToCloud', 'hoverClosest3d', 'tableRotation', 'resetCameraDefault3d'],
                      scrollZoom: true,
              ...
              <Grid item xs={12} xl={6}>
                <Typography variant="subtitle1" sx={{ mb: 1, textAlign: 'center', fontWeight: 600, color: '#10B981' }}>
                  Net Benefit Surface
                </Typography>
                <Box sx={{ 
                  height: { xs: 500, md: 600, lg: 650, xl: 700 }, 
                    ...
                    data={[
                      {
                        ...
                        colorbar: {
                          title: { text: 'Net Benefit (%)', font: { size: 14 } },
                          tickfont: { color: '#fff', size: 12 },
                          thickness: 15,
                          len: 0.8,
                          x: 1.01,
        ...
        <Grid container spacing={2}>
          ...
          <Grid item xs={12} lg={4}>
            <GlassCard sx={{ 
              ...
              <Box p={2}>
                <Typography variant="subtitle1" sx={{ mb: 1.5, fontWeight: 600, color: '#6DAEFF' }}>
                ...
                <Box sx={{ 
                  ...
                  <Plot
                    data={[
                      {
                        ...
                        orientation: 'v',
                        measure: ['relative', 'relative', 'relative', 'total'] as any,
                        ...
                        text: [
                          ...
                          `${((results.decomposition.tracking_error - Math.sqrt(Math.pow(results.decomposition.te_eth_only, 2) + Math.pow(results.decomposition.te_sol_only, 2))) * 100).toFixed(3)}%`,
                          `${(results.decomposition.tracking_error * 100).toFixed(3)}%`
                        ],
                        y: [
                          results.decomposition.te_eth_only * 100,
                          results.decomposition.te_sol_only * 100,
                          (results.decomposition.tracking_error - Math.sqrt(Math.pow(results.decomposition.te_eth_only, 2) + Math.pow(results.decomposition.te_sol_only, 2))) * 100,
                        ...
                        hovertemplate: '%{x}<br>Tracking Error: %{y:.3f}%<br>Contribution: %{customdata}%<extra></extra>',
                        customdata: [
                          results.decomposition.eth_contribution_pct.toFixed(1),
                          results.decomposition.sol_contribution_pct.toFixed(1),
                          results.decomposition.cross_contribution_pct.toFixed(1),
                          '100.0'
                        ]
                      } as any
                    ]}
                    layout={{
                      ...
                      xaxis: {
                        title: { text: 'Component', font: { size: 12, color: '#fff' } },
                        tickfont: { color: '#fff', size: 11 },
                        gridcolor: 'rgba(109,174,255,0.1)',
                        zerolinecolor: 'rgba(109,174,255,0.2)'
                      },
                      yaxis: {
                        title: { text: 'Tracking Error (%)', font: { size: 12, color: '#fff' } },
                        tickfont: { color: '#fff', size: 11 },
                        gridcolor: 'rgba(109,174,255,0.1)',
                        zerolinecolor: 'rgba(109,174,255,0.2)',
                        tickformat: '.3f',
                        range: [0, results.decomposition.tracking_error * 100 * 1.75]
                      },
                      font: { color: '#fff' },
                      showlegend: false,
                      hoverlabel: {
          ...
          <Grid item xs={12} lg={8}>
            <GlassCard sx={{ height: '100%' }}>
              <Box p={2}>
                <Typography variant="subtitle1" sx={{ mb: 1.5, fontWeight: 600, color: '#10B981' }}>
                  Yield Benefits
                </Typography>
                    ...
                    <TableBody>
                      <TableRow>
                        ...
                        <TableCell align="right" sx={{ 
                          ...
                          <Box>
                            <Box>{(results.net_benefit.eth_benefit_baseline * 100).toFixed(3)}%</Box>
                            <Box sx={{ fontSize: '0.875rem', color: 'rgba(255,255,255,0.6)' }}>
                              {formatCurrency(calculateDollarValue(results.net_benefit.eth_benefit_baseline))}
                            </Box>
                          </Box>
                        </TableCell>
                        <TableCell align="right" sx={{ 
                          ...
                          <Box>
                            <Box>{(results.net_benefit.sol_benefit_baseline * 100).toFixed(3)}%</Box>
                            <Box sx={{ fontSize: '0.875rem', color: 'rgba(255,255,255,0.6)' }}>
                              {formatCurrency(calculateDollarValue(results.net_benefit.sol_benefit_baseline))}
                            </Box>
                          </Box>
                        </TableCell>
                      </TableRow>
                      <TableRow>
                        ...
                        <TableCell align="right" sx={{ 
                          ...
                          <Box>
                            <Box>{(results.net_benefit.eth_benefit_marginal * 100).toFixed(3)}%</Box>
                            <Box sx={{ fontSize: '0.875rem', color: 'rgba(255,255,255,0.6)' }}>
                              {formatCurrency(calculateDollarValue(results.net_benefit.eth_benefit_marginal))}
                            </Box>
                          </Box>
                        </TableCell>
                        <TableCell align="right" sx={{ 
                          ...
                          <Box>
                            <Box>{(results.net_benefit.sol_benefit_marginal * 100).toFixed(3)}%</Box>
                            <Box sx={{ fontSize: '0.875rem', color: 'rgba(255,255,255,0.6)' }}>
                              {formatCurrency(calculateDollarValue(results.net_benefit.sol_benefit_marginal))}
                            </Box>
                          </Box>
                        </TableCell>
                      </TableRow>
                      <TableRow>
                        ...
                        <TableCell align="right" sx={{ 
                          ...
                          <Box>
                            <Box>{(results.net_benefit.eth_benefit_total * 100).toFixed(3)}%</Box>
                            <Box sx={{ fontSize: '0.875rem', color: 'rgba(255,255,255,0.6)' }}>
                              {formatCurrency(calculateDollarValue(results.net_benefit.eth_benefit_total))}
                            </Box>
                          </Box>
                        </TableCell>
                        <TableCell align="right" sx={{ 
                          ...
                          <Box>
                            <Box>{(results.net_benefit.sol_benefit_total * 100).toFixed(3)}%</Box>
                            <Box sx={{ fontSize: '0.875rem', color: 'rgba(255,255,255,0.6)' }}>
                              {formatCurrency(calculateDollarValue(results.net_benefit.sol_benefit_total))}
                            </Box>
                          </Box>
                        </TableCell>
                      </TableRow>
                  ...
                  <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'baseline' }}>
                    ...
                    <Box sx={{ textAlign: 'right' }}>
                      ...
                      <Typography sx={{ fontSize: '0.875rem', color: 'rgba(255,255,255,0.6)' }}>
                        {formatCurrency(calculateDollarValue(results.net_benefit.total_yield_benefit))}
                      </Typography>
                    </Box>
                  </Box>
                </Box>

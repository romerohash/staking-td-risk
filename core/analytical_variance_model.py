...
class StochasticVarianceModel:
    ...
    def analytical_tracking_error(
        self, lambda_redemptions: float, mean_r: float, var_r: float, duration_days: int
    ) -> float:
        """
...
def corrected_stochastic_example():
    ...
    print('=' * 60)
    print('Expected redemptions: 20')
    print('Mean redemption size: 30%')
    print('Redemption std dev: 10%')
